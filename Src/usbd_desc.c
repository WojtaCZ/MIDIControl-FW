...
#define USBD_MANUFACTURER_STRING     "Vojtech Vosahlo"
#define USBD_PID     22334
#define USBD_PRODUCT_STRING     "MIDIControl"
#define USBD_CONFIGURATION_STRING     "Miscelaneous"
#define USBD_INTERFACE_STRING     "Miscelaneous"
