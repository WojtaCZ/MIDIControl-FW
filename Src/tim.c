...
void MX_TIM7_Init(void)
{
  ...
  htim7.Instance = TIM7;
  htim7.Init.Prescaler = 14400;
  htim7.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim7.Init.Period = 625;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM15_MspPostInit 0 */
    ...
    PB14     ------> TIM15_CH1 
    */
    GPIO_InitStruct.Pin = FRONT_LED_DIN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM15;
    HAL_GPIO_Init(FRONT_LED_DIN_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM17_MspPostInit 0 */
    ...
    PB5     ------> TIM17_CH1 
    */
    GPIO_InitStruct.Pin = BACK_LED_DIN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF10_TIM17;
    HAL_GPIO_Init(BACK_LED_DIN_GPIO_Port, &GPIO_InitStruct);
